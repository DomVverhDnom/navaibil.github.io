...
const features = [
  {
    ...
    text: 'Несколько закрытых каналов: у каждого своя лента и общий чат. В своём канале вы владелец и раздаёте роли; в чужих — обычный участник.',
  },
  {
    title: 'Личный кабинет',
    text: 'Профиль, срок доступа и управление подпиской — без лишнего шума, в одном интерфейсе.',
  },
  {
    title: 'Чат и обсуждения',
    text: 'Общий чат для подписчиков и комментарии к постам в реальном времени.',
  },
  {
    title: 'Оформление',
    text: 'Тёмный фон и спокойные голубые акценты в духе привычного мессенджера.',
  },
]
</script>
  ...
  <div class="home">
    <section class="hero">
      ...
      <div class="hero__content">
        <p class="hero__eyebrow">Закрытые каналы</p>
        <h1 class="hero__title">
          Материалы и общение
          <span class="gold-gradient-text">для своих</span>
        </h1>
        <p class="hero__lead">
          Подписки по каналам, отдельные ленты и чаты — несколько независимых клубов на одном сервере.
        </p>
    ...
    <section class="section">
      <h2 class="section__title">Как устроено</h2>
      <p class="section__subtitle">
        Регистрация, вступление в канал (или создание своего), оплата подписки на канал — когда подключите платёжку.
      </p>
      <div class="grid">
    ...
    <section class="cta">
      <div class="cta__inner premium-glow">
        <h2 class="cta__title">Готовы подключиться</h2>
        <p class="cta__text">
          Выберите канал и тариф — откроются лента и чат именно этого канала. Логику оплаты можно доработать под ваш процесс.
        </p>
        <RouterLink to="/channels" class="btn btn--dark">Каналы и доступ</RouterLink>
      </div>
    </section>
  </div>
</template>
